...
class TestBoggle(unittest.TestCase):
    ...
    def test_grid_size_is_width_time_height(self):
        """
    ...
    def test_all_grid_neighbours(self):
        """
        Esnure that all of the grid positions have neighbours
        """
        grid = boggle.make_grid(2,2)
    ...
    def test_load_dictionary(self):
        """
        Test that get_dictionary function returns a dictionary
